...
class TranslationsKkSeeder extends Seeder
{
    ...
    private function lessonsKk(): void
    {
        $updates = [
            ...
            ['title' => 'Разделы компьютерных наук', 'title_kk' => 'Компьютерлік ғылым бөлімдері', 'content_kk' => "Информатика — ақпаратты жинау, сақтау, өңдеу және беру әдістері туралы ғылым.\n\nIT (ақпараттық технологиялар) — техника мен бағдарламаларды өмірде және бизнесте қолдану. Бағдарламалау — информатиканың бір бөлігі, бағдарламалар құру.\n\nКомпьютерлік ғылым бөлімдері: алгоритмдер, бағдарламалау, деректер қорлары, желілер, қауіпсіздік, жасанды интеллект. Барлығы информатика негіздері мен логикаға сүйенеді."],
            ['title' => 'Введение в C++. Настройка среды', 'title_kk' => 'C++ кіріспе. Ортаны баптау', 'content_kk' => "C++ — жалпы мақсаттағы бағдарламалау тілі: жүйелік бағдарламалардан ойындар мен қолданбаларға дейін.\n\nЖұмыс істеу үшін компилятор (GCC, Clang, MSVC) және әзірлеу ортасы (IDE): Visual Studio, Code::Blocks, Qt Creator немесе кеңейтулері бар VS Code керек.\n\nОрнату: компилятор мен IDE жүктеп, орнату, «Консоль қолданбасы» жобасын құру, «Hello, World!» бағдарламасын жазу. Компиляция бастапқы кодты орындалатын файлға айналдырады."],
            ['title' => '1.1 Информация и данные', 'title_kk' => '1.1 Ақпарат және деректер', 'content_kk' => "Бұл сабақта негізгі ұғымдарды талқылаймыз: ақпарат деген не, ол деректерден қалай ерекшеленеді және компьютер бұл біліммен қалай жұмыс істейді.\n\nАқпарат — қоршаған әлем туралы мәліметтер. Деректер — ақпараттың формальды түрде (сандар, таңбалар, кодтар) ұсынылуы, компьютерде сақтау мен өңдеуге ыңғайлы.\n\nАқпарат өлшем бірліктері: бит (0 немесе 1), байт (8 бит), килобайт, мегабайт. Бұл — бағдарламалау мен алгоритмдерді оқымас бұрын қажет болатын база."],
        ];
    ...
    private function quizzesAndQuestionsKk(): void
    {
        $quizTitles = [
            ...
            'Квиз: ООП' => 'Квиз: ООП',
            'Квиз: Основы Информатики' => 'Квиз: Информатика негіздері',
            'Квиз: C++ среда' => 'Квиз: C++ ортасы',
        ];
        ...
        $questionsKk = [
            ...
            'Правильный ответ в тесте можно выбрать:' => ['text_kk' => 'Тестте дұрыс жауапты таңдауға болады:', 'options_kk' => ['A' => 'Тек біреуін', 'B' => 'Сұраққа байланысты бір немесе бірнешеуін', 'C' => 'Әрқашан бірнешеуін']],
            'После прохождения квиза важно:' => ['text_kk' => 'Квизден кейін маңыздысы:', 'options_kk' => ['A' => 'Материалды ұмыту', 'B' => 'Қателерді талдап, тақырыпты бекіту', 'C' => 'Нәтижеге қарамау']],
            'Килобайт — это примерно:' => ['text_kk' => 'Килобайт шамамен:', 'options_kk' => ['A' => '100 байт', 'B' => '1000 байт', 'C' => '10000 байт']],
            'Свойство «массовость» алгоритма означает:' => ['text_kk' => 'Алгоритмнің «массалылық» қасиеті нені білдіреді:', 'options_kk' => ['A' => 'Бір рет жазып, көптеген есептерге қолдануға болады', 'B' => 'Тек бір жағдайға арналған', 'C' => 'Өте үлкен код']],
            'Операция НЕ (NOT) инвертирует:' => ['text_kk' => 'ЕМЕС (NOT) амалы инвертирует (терістейді):', 'options_kk' => ['A' => 'Санды', 'B' => 'Логикалық мәнді', 'C' => 'Жолды']],
            'Тип данных bool хранит:' => ['text_kk' => 'bool деректер типі сақтайды:', 'options_kk' => ['A' => 'Тек сандарды', 'B' => 'Ақиқат немесе жалған мәнін', 'C' => 'Мәтінді']],
            'Ветвление if-else нужно для:' => ['text_kk' => 'if-else тармақталуы керек:', 'options_kk' => ['A' => 'Кодты қайталау үшін', 'B' => 'Шарт бойынша әрекетті таңдау үшін', 'C' => 'Айнымалыны жариялау үшін']],
            'Длина строки — это:' => ['text_kk' => 'Жолдың ұзындығы — бұл:', 'options_kk' => ['A' => 'Байт саны', 'B' => 'Таңбалар саны', 'C' => 'Тек сандар үшін']],
            'Многомерный массив — это:' => ['text_kk' => 'Көп өлшемді массив — бұл:', 'options_kk' => ['A' => 'Бір элементі бар массив', 'B' => 'Элементтері массив бола алатын массив', 'C' => 'Тек екі өлшемді массив']],
            'INSERT в SQL используется для:' => ['text_kk' => 'SQL-дегі INSERT не үшін қолданылады:', 'options_kk' => ['A' => 'Жолдарды жою үшін', 'B' => 'Жаңа жазбаларды қосу үшін', 'C' => 'Тек таңдау үшін']],
            'UPDATE в SQL меняет:' => ['text_kk' => 'SQL-дегі UPDATE өзгертеді:', 'options_kk' => ['A' => 'Кесте құрылымын', 'B' => 'Шарт бойынша бар жазбаларды', 'C' => 'Тек бір кестені бүкіл ДҚ-да']],
            'Класс в CSS задаётся через:' => ['text_kk' => 'CSS-те класс былай беріледі:', 'options_kk' => ['A' => 'class=\"...\"', 'B' => 'id=\"...\"', 'C' => 'Тек JS ішінде']],
            'Приватное поле (private) доступно:' => ['text_kk' => 'private өрісі қол жетімді:', 'options_kk' => ['A' => 'Бағдарламаның барлық жерінде', 'B' => 'Тек класс ішінде', 'C' => 'Тек басқа класта']],
            'Конструктор класса вызывается:' => ['text_kk' => 'Класс конструкторы қашан шақырылады:', 'options_kk' => ['A' => 'Объект жойылғанда', 'B' => 'Объект жасалғанда', 'C' => 'Тек қолмен шақырғанда']],
            'Информация — это:' => ['text_kk' => 'Ақпарат — бұл:', 'options_kk' => ['A' => 'Тек сандар', 'B' => 'Объектілер мен құбылыстар туралы мәліметтер', 'C' => 'Тек мәтін']],
        ];
