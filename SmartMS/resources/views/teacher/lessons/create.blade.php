<x-app-layout>
    ...
    <form action="{{ route('teacher.sections.lessons.store', $section) }}" method="POST" enctype="multipart/form-data" class="max-w-xl space-y-4">
        ...
        <div>
            ...
            <input type="text" name="video_url" value="{{ old('video_url') }}" placeholder="{{ __('messages.teacher_placeholder_video_url') }}" autocomplete="off" class="w-full rounded-lg border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 px-4 py-2">
        ...
        <div>
            ...
            <input type="text" name="video_id" value="{{ old('video_id') }}" placeholder="{{ __('messages.teacher_placeholder_video_id') }}" autocomplete="off" class="w-full rounded-lg border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 px-4 py-2">
        ...
        <div>
            ...
            <input type="text" name="video_url_kk" value="{{ old('video_url_kk') }}" placeholder="{{ __('messages.teacher_placeholder_video_url') }}" autocomplete="off" class="w-full rounded-lg border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 px-4 py-2">
        ...
        <div>
            ...
            <input type="text" name="video_id_kk" value="{{ old('video_id_kk') }}" placeholder="{{ __('messages.teacher_placeholder_video_id') }}" autocomplete="off" class="w-full rounded-lg border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 px-4 py-2">
