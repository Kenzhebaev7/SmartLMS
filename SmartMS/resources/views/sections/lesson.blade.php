        ...
        @if($isProgramming)
            <div class="mb-8 p-4 rounded-xl border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-800/50">
                ...
                @if($isCpp)
                    ...
                    <div class="rounded-lg overflow-hidden border border-slate-200 dark:border-slate-600 bg-white" style="height: 400px;">
                        <iframe src="https://www.onlinegdb.com/embed/cpp?theme=dark" style="width:100%;height:100%;border:none;" title="{{ __('messages.lessons_ide_cpp_title') }}" allow="fullscreen" sandbox="allow-scripts allow-same-origin allow-forms allow-popups"></iframe>
                    </div>
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">
                        {{ __('messages.lessons_ide_open_new_tab') }}:
                        <a href="https://www.onlinegdb.com/online_c++_compiler" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline font-medium">{{ __('messages.lessons_ide_open_cpp') }}</a>
                    </p>
                @endif
                @if($isPython)
                    <p class="text-sm text-slate-600 dark:text-slate-400 mb-2 mt-4">{{ __('messages.lessons_ide_python_hint') }}</p>
                    <div class="rounded-lg overflow-hidden border border-slate-200 dark:border-slate-600 bg-white" style="height: 400px;">
                        <iframe src="https://trinket.io/embed/python3/9477b87339?runMode=editor" style="width:100%;height:100%;border:none;" title="{{ __('messages.lessons_ide_python_title') }}" allow="fullscreen" sandbox="allow-scripts allow-same-origin allow-forms allow-popups"></iframe>
                    </div>
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">
                        {{ __('messages.lessons_ide_open_new_tab') }}:
                        <a href="https://trinket.io/python3" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline font-medium">{{ __('messages.lessons_ide_open_python') }}</a>
                    </p>
                @endif
                @if(!$isCpp && !$isPython)
                    <p class="text-sm text-slate-600 dark:text-slate-400 mb-2">{{ __('messages.lessons_ide_cpp_hint') }}</p>
                    <div class="rounded-lg overflow-hidden border border-slate-200 dark:border-slate-600 bg-white mb-4" style="height: 350px;">
                        <iframe src="https://www.onlinegdb.com/embed/cpp?theme=dark" style="width:100%;height:100%;border:none;" title="{{ __('messages.lessons_ide_cpp_title') }}" allow="fullscreen" sandbox="allow-scripts allow-same-origin allow-forms allow-popups"></iframe>
                    </div>
                    ...
                    <div class="rounded-lg overflow-hidden border border-slate-200 dark:border-slate-600 bg-white" style="height: 350px;">
                        <iframe src="https://trinket.io/embed/python3/9477b87339?runMode=editor" style="width:100%;height:100%;border:none;" title="{{ __('messages.lessons_ide_python_title') }}" allow="fullscreen" sandbox="allow-scripts allow-same-origin allow-forms allow-popups"></iframe>
                    </div>
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">
                        {{ __('messages.lessons_ide_open_new_tab') }}:
